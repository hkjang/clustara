...
| **PR8** | ClickHouse 장기 분석 | DW-01~10 | PR1·5·6 | fact sink(change/event/health/security/cost/action/pod·node metric) via 기존 insertJSONEachRow, ClickHouse 미구성 시 no-op | ✅ 완료(핵심) |
