...
- **Clustara 주소**: 예시 `http://clustara.intra:8080`
...
| 항목 | 기존 | 변경 |
| --- | --- | --- |
| Base URL | `https://api.openai.com/v1` | `http://clustara.intra:8080/v1` |
...
2. `http://clustara.intra:8080/v1` 입력
...
2. Base URL: `http://clustara.intra:8080/v1`
3. API Key: `pcg_...`
...
3. URL: `http://clustara.intra:8080/v1`
4. API Key: `pcg_...`
  ...
  "models": [
    {
      ...
      "provider": "openai",
      "model": "gpt-4.1-mini",
      "apiBase": "http://clustara.intra:8080/v1",
      "apiKey": "pcg_xxxxxxxx..."
    }
  ]
}
...
client = OpenAI(
    base_url="http://clustara.intra:8080/v1",
...
const client = new OpenAI({
  baseURL: "http://clustara.intra:8080/v1",
  apiKey: "pcg_xxxxxxxx...",
});
...
```bash
curl http://clustara.intra:8080/v1/chat/completions \
...
Clustara 어드민 UI (`http://clustara.intra:8080/admin`) 에 접근 권한이 있으면:
...
curl -H "Authorization: Bearer $ADMIN_TOKEN" \
  http://clustara.intra:8080/admin/users
```
...
```bash
curl -fsS http://clustara.intra:8080/v1/models | head
```
