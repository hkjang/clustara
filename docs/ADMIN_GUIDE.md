...
- API: `GET /admin/gitops/overview`, `GET/POST /admin/gitops/sources`, `GET /admin/gitops/drift`, `GET/POST /admin/gitops/pr-drafts`, `GET/POST /admin/gitops/progressive-rollouts`, `GET/POST /admin/gitops/change-calendar`, `GET/POST /admin/gitops/deployment-evidence`, `GET/POST /admin/gitops/rollback-plans`
