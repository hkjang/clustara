...
운영(운영 홈·클러스터·변경 타임라인·장애 분석·장애 워룸·리소스 그래프·연결성 점검·액션 승인함·용량·자동확장·그룹·오너십·AI 분석) · 비용 · 보안 · 정책 센터 · 운영 설정 · 설정.
...
2. 장애 후보는 **장애 워룸**에서 근거·영향도·변경 이력 확인
3. **리소스 그래프**와 **연결성 점검**으로 Service/Ingress/PVC 영향 범위와 이상 점검
