...
var apiEndpoints = []apiEndpoint{
	...
	{"/admin/k8s/services/instances/{id}/backups", []string{"get", "post"}, "service-platform", "List backup ledger or create an approval-ready PostgreSQL logical/CSI VolumeSnapshot backup draft", false},
	{"/admin/k8s/services/backups/{backupId}/restore-preview", []string{"post"}, "service-platform", "Validate logical restore or safe CSI VolumeSnapshot clone-PVC impact before approval", false},
	{"/admin/k8s/services/backups/{backupId}/restore", []string{"post"}, "service-platform", "Create an approval-ready PostgreSQL restore Job or VolumeSnapshot clone-PVC draft", false},
