...
func (s *Server) registerEnterpriseRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/admin/catalog/entities/", s.handleCatalogEntityRuntime)
	mux.HandleFunc("/admin/catalog/entities", s.handleCatalogEntities)
	mux.HandleFunc("/admin/catalog/coverage", s.handleCatalogCoverage)
	mux.HandleFunc("/admin/catalog/gap-exceptions", s.handleCatalogGapExceptions)
	mux.HandleFunc("/admin/catalog/gaps", s.handleCatalogGaps)
	mux.HandleFunc("/admin/catalog/ownership-map", s.handleCatalogOwnershipMap)
	mux.HandleFunc("/admin/catalog/runtime-candidates", s.handleCatalogRuntimeCandidates)
	mux.HandleFunc("/admin/catalog/scorecards", s.handleCatalogScorecards)
	mux.HandleFunc("/admin/catalog/self-service-actions", s.handleCatalogSelfServiceActions)
